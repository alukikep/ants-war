var A=Object.defineProperty;var S=(a,e,s)=>e in a?A(a,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):a[e]=s;var r=(a,e,s)=>S(a,typeof e!="symbol"?e+"":e,s);import{H as g,T as v,A as O}from"./index-DJnpIZsk.js";const H=["upgrade_focus","build_focus","iterate"];function f(a,e){const s=e.stats,o=[];s.damage&&o.push(`攻${s.damage>0?"+":""}${s.damage}`),s.hp&&o.push(`血${s.hp>0?"+":""}${s.hp}`),s.speed&&o.push(`速${s.speed>0?"+":""}${s.speed}`),s.attackSpeed&&o.push(`攻速${s.attackSpeed>0?"+":""}${s.attackSpeed}%`);const n=o.length?o.join("/"):"无加成";return`- ${a}(${e.nameCN}) 价${e.cost} ${n}`}function j(a,e,s){const o=a.map(i=>f(i,g[i])).join(`
