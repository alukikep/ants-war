var w=Object.defineProperty;var O=(s,e,t)=>e in s?w(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t;var r=(s,e,t)=>O(s,typeof e!="symbol"?e+"":e,t);import{H as $,T as H,A as j}from"./index-CIjIO4k9.js";const _=["upgrade_focus","build_focus","iterate"];function v(s,e){const t=e.stats,a=[];t.damage&&a.push(`攻${t.damage>0?"+":""}${t.damage}`),t.hp&&a.push(`血${t.hp>0?"+":""}${t.hp}`),t.speed&&a.push(`速${t.speed>0?"+":""}${t.speed}`),t.attackSpeed&&a.push(`攻速${t.attackSpeed>0?"+":""}${t.attackSpeed}%`);const o=a.length?a.join("/"):"无加成";return`- ${s}(${e.nameCN}) 价${e.cost} ${o}`}function D(s,e,t){const a=s.map(i=>v(i,$[i])).join(`
