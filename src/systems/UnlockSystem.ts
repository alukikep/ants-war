...
import { getHeadConfig, getThoraxConfig, getAbdomenConfig, HEAD_CONFIGS, THORAX_CONFIGS, ABDOMEN_CONFIGS } from '../config/partStats';
import type { Side, UnlockablePartDef } from '../types';
